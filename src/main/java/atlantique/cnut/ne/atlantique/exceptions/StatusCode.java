...
public enum StatusCode {
    ...
    HTTP_OK("200", "Requête traitée avec succès."),
    HTTP_TOKEN_GENERATED("200", "Token généré avec succès."),
    HTTP_LOGOUT_SUCCESS("200", "Déconnexion effectuée avec succès."),

    // --- 4xx Client Errors ---
    HTTP_BAD_REQUEST("400", "Requête invalide."),
    HTTP_UNAUTHORIZED("401", "Non autorisé. Veuillez vous authentifier."),
    HTTP_FORBIDDEN("403", "Accès interdit."),
    HTTP_NOT_FOUND("404", "Ressource non trouvée."),
    HTTP_CONFLICT("409", "Conflit avec l'état actuel de la ressource."),
    HTTP_RATE_LIMIT_EXCEEDED("429", "Trop de requêtes. Veuillez réessayer plus tard."),

    // --- 5xx Server Errors ---
    HTTP_INTERNAL_SERVER_ERROR("500", "Erreur interne du serveur."),
    HTTP_SERVICE_UNAVAILABLE("503", "Service indisponible."),
